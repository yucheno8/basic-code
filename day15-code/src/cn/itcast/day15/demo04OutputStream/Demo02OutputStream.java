...
public class Demo02OutputStream {
    public static void main(String[] args) throws IOException {
        ...
        FileOutputStream fos = new FileOutputStream(new File("day15-code\\src\\cn\\itcast\\day15\\demo04OutputStream\\b.txt"));
        ...
        /*
            ...
            一次写多个字节：
                ...
                如果写的一个字节是负数，那第一个字节和第二个字节，两个字节组成一个中文显示，查询系统默认码表（GBK）
         */
